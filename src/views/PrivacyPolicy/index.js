...
const PrivacyPolicy = () => {
  return (
    <Container textAlign="center" className="privacy-policy-container">
      <Segment>
        <Header as="h2">Privacy Policy</Header>
        <p>
          At inenglishwithlove.com, accessible from
          https://www.inenglishwithlove.com/, one of our main priorities is the
          privacy of our visitors. This Privacy Policy document contains types
          of information that is collected and recorded by inenglishwithlove.com
          ...
          shared and/or collect in inenglishwithlove.com. This policy is not
          ...
          us directly, we may receive additional information about you such as
          ...
          address, email address, and telephone number. How we use your
          information We use the information we collect in various ways,
          including to: Provide, operate, and maintain our webste Improve,
          personalize, and expand our webste Understand and analyze how you use
          our webste Develop new products, services, features, and functionality
          ...
          inenglishwithlove.com follows a standard procedure of using log files.
          ...
          Generator. Cookies and Web Beacons Like any other website,
          inenglishwithlove.com uses 'cookies'. These cookies are used to store
          ...
          inenglishwithlove.com. Third-party ad servers or ad networks uses
          ...
          inenglishwithlove.com, which are sent directly to users' browser. They
          automatically receive your IP address when this occurs. These
          technologies are used to measure the effectiveness of their
          advertising campaigns and/or to personalize the advertising content
          that you see on websites that you visit. Note that
          inenglishwithlove.com has no access to or control over these cookies
          that are used by third-party advertisers. Third Party Privacy Policies
          inenglishwithlove.com's Privacy Policy does not apply to other
          ...
          activity. inenglishwithlove.com does not knowingly collect any
